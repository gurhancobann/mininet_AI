...
def startNetwork():
	...
	floodlightRestApi.addACL(net.getNodeByName("h2").IP(),net.getNodeByName("h4").IP(),"deny")
	floodlightRestApi.addACL(net.getNodeByName("h3").IP(),net.getNodeByName("h4").IP(),"deny")
	#net.pingAll() 
	#d
...
def yayin(host):
	...
	floodlightRestApi.addACL(net.getNodeByName("h2").IP(),net.getNodeByName("h4").IP(),"allow")
	floodlightRestApi.addACL(net.getNodeByName("h3").IP(),net.getNodeByName("h1").IP(),"deny")
	port="1234"
