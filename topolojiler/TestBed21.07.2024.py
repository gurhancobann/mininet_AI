...
def startNetwork():
	...
	hosts=["h13","h1","h2","h3","h4","h5","h6","h7","h8","h9","h11","h12"]
	...
	info(f'Başlama saati: {baslangic}\nBitiş Saati: {datetime.datetime.now()}')
