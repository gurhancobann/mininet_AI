...
def selectServer4(receivers):
	...
	h10Node=net.getNodeByName("h10")
	h10_mac=h10Node.MAC()
	h14Node=net.getNodeByName("h14")
	h14_mac=h14Node.MAC()
	hosts=[]
	for receiver in receivers:
		...
		if(len(serverList)==0):
			...
			sleep(3)
			latencyh10,hop_counth10=floodlightRestApi.getPathInfo(dst_host_mac,h10_mac)
			latencyh14,hop_counth14=floodlightRestApi.getPathInfo(dst_host_mac,h14_mac)
			if(latencyh10<latencyh14):
