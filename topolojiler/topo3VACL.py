...
def startNetwork():
	...
	servers=["h10","h14"]
	hosts=["h7","h8","h9","h11","h12","h13","h21","h22","h23","h24","h25","h26","h27","h28","h29","h30","h1","h2","h3","h4","h5","h6"]
...
def selectServer(receivers,servers):
	...
	for receiver in receivers:
		...
		if(len(serverList)==0):
			...
			sleep(3)
			h10ftoplam,h14ftoplam,h10gelen,h10giden,h14gelen,h14giden=testHostFloodlight(receiver,h10Toplam,h14Toplam)
...
def testHostFloodlight(receiver,h10,h14):
	...
	if(h10_sure==0):
		...
		if (yuk1 < yuk2):
			...
			serverList[receiver]="h14"
	print(json.dumps(serverList,indent=4))
	return (h10_alinan_bytes+h10_iletilen_bytes),(h14_alinan_bytes+h14_iletilen_bytes),h10_alinan_bytes,h10_iletilen_bytes,h14_alinan_bytes,h14_iletilen_bytes
